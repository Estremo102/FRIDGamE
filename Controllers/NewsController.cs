...
namespace FRIDGamE.Controllers
{
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AddDate,Headline,Content,AuthorId")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AddDate,Headline,Content,AuthorId")] News news)
        {
            if (id != news.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'IdentityContext.News'  is null.");
            }
            var news = await _context.News.FindAsync(id);
            if (news != null)
            {

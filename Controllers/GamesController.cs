...
namespace FRIDGamE.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,GameName,StudioId,GamePublisherId,RegularPrice,ReleaseDate")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,GameName,StudioId,GamePublisherId,RegularPrice,ReleaseDate")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
